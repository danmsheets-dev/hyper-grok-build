    ...
    fn plan_approval_shortcut_hints(
        ...
        match pav.focus {
            ...
            PlanApprovalFocus::Preview => {
                let copy_plan_label = format!(
                    "{} {}",
                    rust_i18n::t!("hints.copy"),
                    rust_i18n::t!("hints.plan")
                );
                vec![
                    HintItem::new(key!('y'), copy_plan_label),
                    HintItem::new(key!(Tab), rust_i18n::t!("hints.prompt")),
                ]
            }
        }
    }
    ...
    fn question_shortcut_hints(
        ...
        match qv.focus {
            ...
            QuestionFocus::InputMode if qv.is_feedback() => {
                vec![HintItem::new(key!(Enter), rust_i18n::t!("hints.send")), esc]
            }
